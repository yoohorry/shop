<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"C:\laragon\www\shop\public/../application/index\view\index\info.html";i:1527248894;s:54:"C:\laragon\www\shop\application\index\view\layout.html";i:1527300641;}*/ ?>
<!doctype html>
<html lang="zh-CN">
...
<body>
  ...
  <header class="header">
    ...
    <section class="goods-info">
        <div class="container">
            <div class="row goods-info-box">
                <div class="col-lg-6 text-center">
                    <img src="/uploads/<?php echo $deal->image; ?>" class="goods-img">
                    <p class="goods-info-name">
                        <button class="btn btn-info btn-block put-into-cart-index"><i class="fa fa-cart-plus" aria-hidden="true"></i>&nbsp;点击加入购物车</button>
                    </p>
                </div>
                <div class="col-lg-6">
                    <input type="hidden" class="goods-id" value="<?php echo $deal->id; ?>">
                    <p class="goods-info-details"><span class="goods-name"><?php echo $deal->name; ?></span></p>
                    <p class="goods-info-details"> 商品简介：
                        <?php echo $deal->desc; ?>
                    </p>
                    <hr>
                    <p class="goods-info-details"> 商品原价：￥ <span class="origin-price"><?php echo $deal->origin_price; ?></span> </p>
                    <p class="goods-info-details"> 当前售价：￥ <span class="selling_price goods-price be-red"><?php echo $deal->selling_price; ?></span> </p>
                    <hr>
                    <p class="goods-info-details"> 购买须知： <span class="origin-price"><?php echo $deal->note; ?></span> </p>
                </div>
            </div>
        </div>
    </section>
