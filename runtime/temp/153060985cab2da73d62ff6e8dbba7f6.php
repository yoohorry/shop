<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"C:\laragon\www\shop\public/../application/bis\view\user\login.html";i:1525337686;}*/ ?>
<!doctype html>
<html lang="zh-CN">
  <head>
    <!-- 编码 -->
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-header">
            <h4 class="modal-title">请登陆，商户管理员</h4>
          </div>
          ...
          <div class="modal-footer">
            <a href="<?php echo url('User/register'); ?>" class="btn btn-success">申请入驻</a>
